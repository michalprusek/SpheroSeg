#!/bin/bash
# Pretrain script for ResUNet with CBAM on spheroid dataset
...
BATCH_SIZE=7          # Smaller batch size due to CBAM modules
IMG_SIZE=1024
...
echo "======================================================================"
echo "ResUNet CBAM Pretraining Configuration"
echo "======================================================================"
echo "Model: $MODEL"
...
if [ ${PIPESTATUS[0]} -eq 0 ]; then
    ...
    echo "Use this model for finetuning with finetune_resunet_cbam.sh"
    echo "======================================================================"
