#!/bin/bash
# Pretrain script for ResUNet Small (~60M params) on spheroid dataset
# Optimized for 1024x1024 resolution with enhanced regularization
...
echo "======================================================================"
echo "ResUNet Small Pretraining Configuration"
echo "======================================================================"
echo "Model: $MODEL"
...
if [ ${PIPESTATUS[0]} -eq 0 ]; then
    ...
    echo "Use this model for finetuning with finetune_resunet_small.sh"
    echo "======================================================================"
